    ...
    public partial class Main
    {
        ...
        public static void BeforeMoveUsed(BattleSetup setup)
        {
            try
            {
                ...
                else
                {
                    ...
                    else if (setup.Move.AdditionalEffectData1 == 197 && GetBattleTagArg(setup.BattleTags, "SkyDrop", 0) == null)
                    {//sky drop
                        setup.Move.Name = "";
                    }
                }
                ...
                if (setup.Defender != null)
                {
                    ...
                    switch (setup.Move.AdditionalEffectData1)
                    {
                        ...
                        case 29:
                            ...
                            break;
                        case 49:
                            {//high critical rate + status
                                criticalRate = 1250;
                            }
                            break;
                        case 60:
                            {//high critical rate of razor wind
                    ...
                    if (HasActiveBagItem(setup.Attacker, 20, 2, 0))
                    {  // Exclusive-item with Miracle-Eye Effect
                        AddExtraStatus(setup.Attacker, setup.AttackerMap, "MiracleEye", 0, null, "", setup.PacketStack);
                    }
                    if (HasActiveBagItem(setup.Attacker, 20, 9, 0) || HasActiveBagItem(setup.Attacker, 20, 6, 0))
                    {  // Exclusive-item with Exposed Effect
                    ...
                    if (HasActiveBagItem(setup.Defender, 18, 0, 0))
                    { //Exclsuive-item
                        criticalRate = 0;
                    }
                        ...
                        if (status != null)
                        {
                            if (status.Tag == "Bounce")
                            {
                                ...
                                {//gust and twister
                                  ...
                                  setup.moveIndex == 675 || setup.moveIndex == 612)
                                {//thunder/sky upper/hurricane/smack down
                            ...
                            else if (status.Tag == "Fly")
                            {
                                ...
                                {//gust and twister
                                  ...
                                  setup.moveIndex == 675 || setup.moveIndex == 612 || setup.moveIndex == 179)
                                {//thunder/sky upper/hurricane/smack down
                    ...
                    if (setup.Move.Accuracy == -1 || Server.Math.Rand(0, 100) < setup.Move.Accuracy)
                    {
                        ...
                        if (setup.Move.EffectType == Enums.MoveType.SubHP && setup.Defender != null && criticalRate > 0 && Server.Math.Rand(0, 10000) < criticalRate)
                        {//see if it criticals
                            //setup.Critical = true;
            ...
            try
            {
                ...
                switch (setup.Move.Data1)
                {
                            ...
                            if (GetBattleTagArg(setup.BattleTags, "InvokedMove", 0) == null)
                            {
                                ...
                                switch (setup.Move.Data2)
                                {
                                    case 1:
                                        ...
                                        break;
                                    case 2:
                                        {//assist - calls a move from the party
                                        ...
                                        break;
                                    case 3:
                                        {//me first - calls a move from the enemies
                    ...
                    case 209:
                        ...
                        break;
                    case 210:
                        {//nonvolatile status cure with immunity
                    ...
                    case 219:
                        ...
                        break;
                    case 220:
                        {//Increases Atk and SpAtk by 2 (all power up orb)
                            ChangeAttackBuff(setup.Defender, setup.Attacker, setup.DefenderMap, 2, setup.PacketStack);
                            ChangeSpAtkBuff(setup.Defender, setup.Attacker, setup.DefenderMap, 2, setup.PacketStack);
                        }
                        break;
            ...
            try
            {
                ...
                switch (setup.Move.AdditionalEffectData1)
                {
                    ...
                    case 35:
                        ...
                        break;
                    case 37:
                        {//breaks through ice; may cause burn
                            if (setup.Hit && (!setup.KnockedOut || setup.Defender.HP > 0))
                            {
                                if (Server.Math.Rand(0, 100) < setup.Move.AdditionalEffectData2)
                                {
                        ...
                        break;
                    case 38:
                        {//breaks through ice; recoil; may cause burn
                            if (setup.Hit)
                            {
                                if (!setup.KnockedOut || setup.Defender.HP > 0)
                                {
                    ...
                    case 58:
                        {//Partial trapper
                            ...
                            {
                                int trapTime = 3;
                                if (setup.Attacker.HasActiveItem(45))
                                {//Grip Claw
                                    trapTime = 5;
                                }
                                string intensity = "";
                        ...
                        break;
                    case 60:
                        {//charge-up moves (extra effects here)
                            switch (setup.Move.AdditionalEffectData2)
                            {
                                case 4:
                                    {//sky attack
                        ...
                        break;
                    case 61:
                        {//rampage moves (thrash, petal dance, outrage)
                        ...
                        break;
                    case 62:
                        {//rolling moves (rollout, ice ball)
                            if (setup.BattleTags.Contains("HitSomething"))
                            {
                        ...
                        {//pay day payout
                            if (setup.Hit && setup.KnockedOut && setup.Defender.HP <= 0)
                            {
                                if (setup.Defender.CharacterType == Enums.CharacterType.MapNpc && setup.Attacker.CharacterType == Enums.CharacterType.Recruit)
                                {
                                    ...
                                    setup.DefenderMap.SpawnItem(1, payout, false, false, "", setup.DefenderMap.IsZoneOrObjectSandboxed(), setup.Defender.X, setup.Defender.Y, ((Recruit)setup.Attacker).Owner);
                                }
                            }
                        }
                        break;
        ...
        public static void AfterMoveHits(BattleSetup setup)
        {
            ...
            try
            {
                ...
                if (setup.Hit && setup.Defender != null)
                {
                    if (setup.Damage > 0 && setup.Defender.HasActiveItem(480))
                    {//eject button
                        if (setup.DefenderMap.MapType == Enums.MapType.RDungeonMap)
                        {
                    ...
                    if (setup.Damage > 0 &&
                        ...
                        && setup.Defender.HasActiveItem(240))
                    {//red card
                    ...
                    if (setup.Attacker.CharacterType == Enums.CharacterType.Recruit)
                    {
                        ...
                        if (x >= 0 && x <= setup.AttackerMap.MaxX && y >= 0 && y <= setup.AttackerMap.MaxY)
                        {
                            ...
                            if (tile.Type == Enums.TileType.Scripted && GetTrapItem(tile.Data1) > 0 && tile.Data2 > 0)
                            {
                                ...
                                {
                                    //spawn item
                                    setup.AttackerMap.SpawnItem(GetTrapItem(tile.Data1), 1, false, false, "", setup.AttackerMap.IsZoneOrObjectSandboxed(), x, y, null);
