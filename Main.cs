    ...
    public partial class Main
    {
        ...
        public static void LeftGame(Client client)
        {
            try
            {
                ...
                foreach (Client i in ClientManager.GetClients())
                {
                    ...
                    {
                        Messenger.PlayerMsg(i, client.Player.Name + " has left " + Settings.GameName + "!", Text.BrightGreen);
                    }
                }
        ...
        public static string OnChatMessageRecieved(Client client, string message, Enums.ChatMessageType msgType)
        {
            try
            {
                ...
                string[] triggerWords = new string[] {
                    "cum", "fuck", "hack", "shit", "tits", "twat", "pussy", "jism", "jizm",
                    ...
                    "gook", "retard", "ass" , "arse", "assbag", "assbandit", "assbanger",
                     ...
                     "gook", "gringo", "guido", "heeb", "homo", "homodumbshit", "honkey", "humping",
                     "jackass", "jerk off", "jiggaboo", "jizz", "kike", "kooch",
                     ...
                     "piss", "pissed", "pissed off", "Pollock", "poon", "orgy", "poonani", "poonany", "porch monkey",
                     ...
                     "wank", "wetback", "whore", "whorebag", "wop", "paynis", "stfu", "smartass", "smartasses"
                };
            ...
            try
            {
                switch (scriptNum)
                {
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        {//spiritomb room in hallowed well
                            InstancedMap map = new InstancedMap(MapManager.GenerateMapID("i"));
                        ...
                        break;
                    case 9:
                        {//golden apple room in hallowed well
                            InstancedMap map = new InstancedMap(MapManager.GenerateMapID("i"));
                        ...
                        break;
                    case 10:
                        {//golden fang room in hallowed well
                            InstancedMap map = new InstancedMap(MapManager.GenerateMapID("i"));
                    ...
                    case 15:
                        ...
                        break;
                    case 16:
                        {//completed marowak training dojo
                    ...
                    case 23:
                        {//switch-activated dungeon end
                            if (client.Player.Map.Tile[client.Player.X, client.Player.Y].Data1 == 1)
                            {
                                ...
                                PartyManager.AttemptPartyWarp(client, (Client warpClient) =>
                                {
                                    ...
                                    warpClient.Player.Map.SpawnItem(533, 1, false, false, "373;374;375;376;377;378;379;382", warpClient.Player.Map.IsZoneOrObjectSandboxed(), 17 + 2 * (players % 2), 11 + 2 * (players / 2), warpClient);
                        ...
                        break;
                    case 24:
                        {//switch-deactivated end-Harmonic-Tower
                            Messenger.PlayerMsg(client, "The passage to the next floor won't open until the switches are pressed...", Text.BrightRed);
                        }
                        break;
                    case 25:
                        {//end of Harmonic Tower
                    ...
                    case 26:
                        {//end of Mineral Cave
                            ...
                            {
                                client.Player.Map.SpawnItem(49, 1, false, false, "", client.Player.Map.IsZoneOrObjectSandboxed(), 8, 8, null);
                            }
                        }
                        break;
                    case 27:
                        {//completed Mt. barricade
                        ...
                        {//tanren chambers
                            ...
                            if (mapNum > -1)
                            {
                                ...
                                if (warp)
                                {
                                    ...
                                    iMap.SpawnItem(itemNum, 0, false, false, tag, client.Player.Map.IsZoneOrObjectSandboxed(), itemX, itemY, null);
            ...
            try
            {
                ...
                for (int i = 0; i < Constants.MAX_ACTIVETEAM; i++)
                {
                    if (client.Player.Team[i] != null && client.Player.Team[i].Loaded)
                    {
                        ...
                        if (C > 0)
                        {
                            hitlist.AddPacketToMap(client.Player.Map, PacketBuilder.CreateSoundPacket("LevelUp"), client.Player.X, client.Player.Y, 50);
            ...
            try
            {
                ...
                switch (questionID)
                {
                    ...
                    case "DiglettMission":
                        ...
                        break;
                    case "FerryTicketUse":
                        {//originally used in place of Keyblocks during exploitations of the Refresh Glitch.
                            if (answer == "Yes")
                            {
            ...
            try
            {
                ...
                switch (scriptNum)
                {
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        {//Start Registeel Battle: First wave of bronzongs
                            BossBattles.StartBossWave(client, "Registeel", 1);
                        }
                        break;
                    case 11:
                        {//Registeel Battle: second wave of bronzongs
                            BossBattles.StartBossWave(client, "Registeel", 2);
                        }
                        break;
                    case 12:
                        {//Registeel Battle: Registeel itself
                            BossBattles.StartBossWave(client, "Registeel", 3);
                        }
                        break;
                    case 13:
                        {//leaving Forlorn Tower by fee
                    ...
                    case 40:
                        ...
                        break;
                    case 41:
                        { // Post intro boss battle for Seaside Cavern
                            BossBattles.RunPostIntroStoryBossBattle(client, "SeasideCavern");
                        }
                        break;
                    case 42:
                        { // enter dungeon (random)
                    ...
                    case 58:
                        ...
                        break;
                    case 59:
                        {//run post intro story boss battle
        ...
        public static void ScriptedNPC(Client client, int script)
        {
            switch (script)
            {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    {//Kecleons (so people don't accidentally attack them and unleash their rage)
                        Messenger.PlayerMsg(client, "Kelceon: Ah, welcome~!  Feel free to browse among my wares~!", Text.Green);
                    }
                    break;
                case 8:
                    {//blue gives magma rock
                ...
                case 11:
                    ...
                    break;
                case 12:
                    {//Ornaments needed; PMDCP Present given
                    ...
                    break;
                case 13:
                    {//Snowballs needed; Mystery Gift given
                    ...
                    break;
                case 14:
                    {//Yarn needed; Holly Present given
                    ...
                    break;
                case 15:
                    {//Candy needed; Natural Gift given
        ...
        public static void OpenStaffElevator(Client client)
        {
            if (Ranks.IsAllowed(client, Enums.Rank.Monitor))
            {
                ...
                menu.AddLabel(1, 2, 45, 110, 23, "> Staff Lounge", "PMDCP.ttf", 8, Text.Black);
                menu.AddLabel(2, 2, 75, 110, 24, "> Bedrooms 1", "PMDCP.ttf", 8, Text.Black);
                menu.AddLabel(3, 2, 105, 110, 24, "> Bedrooms 2", "PMDCP.ttf", 8, Text.Black);
                menu.AddLabel(4, 2, 135, 110, 24, "> Admin Rooms", "PMDCP.ttf", 8, Text.Black);
                menu.AddLabel(5, 2, 165, 110, 24, "> Building Top", "PMDCP.ttf", 8, Text.Black);
                menu.AddLabel(6, 2, 195, 110, 24, "> Developer Room", "PMDCP.ttf", 8, Text.Black);
                menu.AddLabel(7, 2, 225, 110, 24, "> Library", "PMDCP.ttf", 8, Text.Black);
                menu.AddLabel(8, 2, 255, 110, 24, "> Meeting Room", "PMDCP.ttf", 8, Text.Black);
                menu.AddLabel(9, 2, 285, 110, 24, "> Test Room", "PMDCP.ttf", 8, Text.Black);
        ...
        public static void ScriptedItem(BattleSetup setup, InventoryItem item, int invNum)
        {
            try
            {
                ...
                switch (ItemManager.Items[itemNum].Data1)
                {
                    ...
                    case 26:
                        {//White Flute ~adjust for NPC levels (still unfinished)
                            if (setup.Attacker.CharacterType == Enums.CharacterType.Recruit)
                            {
                                Client client = ((Recruit)setup.Attacker).Owner;
            ...
            if (map.MapType == Enums.MapType.RDungeonMap)
            {
                ...
                if (dungeon != null)
                {
                    if (dungeon.LegendaryId > 0)
                    {
                        ...
                        {
                            if (Server.Math.Rand(0, 100) <= legendary.FragmentSpawnRate)
                            {
        ...
        public static void AddExclusives(Client client, IMap map, PacketHitList packetlist)
        {
            ...
            if (map.MapType == Enums.MapType.RDungeonMap)
            {
                ...
                int minNpcs = map.MinNpcs;
                int maxNpcs = map.MaxNpcs;
                bool onlyOne = false;
                if (client.Player.PartyID == null)
                {
                    onlyOne = true;
        ...
        public static void RandomItemSpawn(IMap map, int itemNum, int amount, bool sticky, bool hidden, string tag)
        {
            ...
            if (x != -1)
            {
                map.SpawnItem(itemNum, amount, sticky, hidden, tag, map.IsZoneOrObjectSandboxed(), x, y, null);
            }
        }
            ...
            try
            {
                switch (triggerEvent.TriggerCommand)
                {
                    ...
                    case -1:
                        ...
                        break;
                    case 1:
                        { // Electrostasis Tower Sublevel Goal [Stepped On Tile]
        ...
        public static void EventCountdown()
        {
            ...
            System.Threading.Thread eventCountdownThread = new System.Threading.Thread(delegate ()
            {
                ...
                for (int a = 20; a >= 1; a--)
                {
                    //Server.Globals.ServerStatus = message + " " + a + " minutes.";
                    Server.Globals.ServerStatus = "An auction will begin in " + a + " minutes.";
                    System.Threading.Thread.Sleep(60000);
                }
                Server.Globals.ServerStatus = "The auction has begun!";
                System.Threading.Thread.Sleep(8000);
                Server.Globals.ServerStatus = "";
            }
            );
            eventCountdownThread.Start();
